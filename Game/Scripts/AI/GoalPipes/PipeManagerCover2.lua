...
function PipeManager:OnInitCover2()
	...
	AI.BeginGoalPipe("cv_short_prone_hide");
		...
		AI.PushGoal("timeout",1,0.0,0.5);
		AI.PushGoal("bodypos",1,BODYPOS_PRONE);
		AI.PushGoal("firecmd",0,FIREMODE_BURST);
		AI.PushGoal("timeout",1,1.5,2.0);
	...
	AI.BeginGoalPipe("cv_short_blind_fire");
		AI.PushGoal("locate", 0,"probtarget");
		AI.PushGoal("firecmd",0,FIREMODE_FORCED,1); -- shoot lastop result
...
--		AI.PushGoal("+firecmd",0,FIREMODE_PANIC_SPREAD,AILASTOPRES_USE);
		...
		AI.PushGoal("branch", 1, "SKIP_BACKOFF", IF_COVER_NOT_COMPROMISED);
			AI.PushGoal("locate",0,"probtarget");
			AI.PushGoal("+seekcover", 1, COVER_HIDE, 7.0, 3, 1); -- 2=towards refpoint
...
--		AI.PushGoal("timeout",1,0.15);
		...
		AI.PushGoal("locate",0,"refpoint");
		AI.PushGoal("+approach",1,5,AILASTOPRES_USE,2.0,"ADVANCE_NOPATH");
...
--		AI.PushGoal("check_cover_fire",1);
		AI.PushGoal("bodypos",1,BODYPOS_STEALTH);
		AI.PushGoal("run",0,2,0,20);
--		AI.PushGoal("+stick",1,5,AILASTOPRES_USE,10.0);
...
--		AI.PushGoal("run",0,2,0,7);
		AI.PushGoal("bodypos",1,BODYPOS_STAND, 1);

		AI.PushGoal("hide", 1, 22, HM_NEAREST_TOWARDS_REFPOINT+HM_INCLUDE_SOFTCOVERS, 0, 6);
--		AI.PushGoal("hide", 1, 17, HM_NEAREST_TOWARDS_REFPOINT);
		
		AI.PushGoal("branch", 1, "HIDE_OK", IF_COVER_NOT_COMPROMISED);
			AI.PushGoal("branch", 1, "INDOOR", IF_NAV_WAYPOINT_HUMAN);
				AI.PushGoal("locate",0,"refpoint");
--				AI.PushGoal("+movetowards",1,16);
	...
	AI.BeginGoalPipe("su_cqb");
		...
		AI.PushGoal("branch", 1, "SKIP_UNHIDE", IF_SEES_TARGET, 20.0);
			...
			AI.PushGoal("branch", 1, "OTHER", IF_RANDOM, 0.5);
				AI.PushGoal("locate",0,"probtarget");
				AI.PushGoal("+seekcover", 1, COVER_UNHIDE, 3.0, 2, 1+2);
			AI.PushLabel("OTHER");
				AI.PushGoal("locate",0,"probtarget");
				AI.PushGoal("+seekcover", 1, COVER_UNHIDE, 6.0, 3, 1+2);
...
--		AI.PushGoal("signal",0,1,"SETUP_PISTOL",0);	
		...
		AI.PushGoal("branch", 1, "HIDE_OK", IF_LASTOP_SUCCEED);
			...
			AI.PushGoal("branch", 1, "OTHER", IF_RANDOM, 0.5);
				AI.PushGoal("locate",0,"refpoint");
				AI.PushGoal("+seekcover", 1, COVER_HIDE, 4.0, 3, 1+2);
			AI.PushLabel("OTHER");
				AI.PushGoal("locate",0,"refpoint");
				AI.PushGoal("+seekcover", 1, COVER_HIDE, 8.0, 3, 1+2);
		AI.PushLabel("HIDE_OK");
