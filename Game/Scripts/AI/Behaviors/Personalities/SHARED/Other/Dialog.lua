...
--
--------------------------	
--   Description: 	to be used while playing dialog - so that it gets interrupted only on some particular events (damage, playerSeen, ...)
--------------------------
...
--AI.LogEvent(">>>> squadmate gets constructed  "..entity:GetName());	
