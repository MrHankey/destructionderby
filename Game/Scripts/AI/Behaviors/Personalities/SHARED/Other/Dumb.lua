--------------------------------------------------
--    Created By: King Luciano
--------------------------------------------------
--	This behavior is used for both Vehicle and Human AI
--  Please make a branch when you add something only for Human :
--  if ( AI.GetTypeOf( target.id ) ~= AIOBJECT_VEHICLE )
