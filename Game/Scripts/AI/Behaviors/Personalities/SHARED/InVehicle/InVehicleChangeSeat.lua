...
--------------------------------------------------------------------------
--  Description: Guy change Seat
--------------------------------------------------------------------------
--  History:
--  2007   : Created by Tetsuji Iwasaki
--------------------------------------------------------------------------

AIBehaviour.InVehicleChangeSeat = {

	Name = "InVehicleChangeSeat",
	Base = "InVehicle",
	...
	ACT_DUMMY = function( self, entity, sender, data )
		self:INVEHICLE_CHANGESEAT( entity, data );
	end,

	--------------------------------------------------------------------------
	INVEHICLE_CHANGESEAT = function( self, entity, data )
		...
		Script.SetTimerForFunction( 500, "AIBehaviour.InVehicleChangeSeat.INVEHICLE_CHANGESEAT_SUB", entity );
