Frogs = {
  type = "Boids",
	...
	Properties = {
		...
		{
			nCount = 10,
			object_Model = "objects/characters/animals/Frog/Frog.chr",
			Size = 1,
			SizeRandom = 0,
			Mass = 1,
		},
	...
	{
                          "Sounds/environment:random_oneshots_natural:frog_idle",   -- idle
                          "Sounds/environment:random_oneshots_natural:frog_scared",  -- scared
                          "Sounds/environment:random_oneshots_natural:frog_idle",    -- die
                          "Sounds/environment:random_oneshots_natural:frog_idle",  -- pickup
                          "Sounds/environment:random_oneshots_natural:frog_idle",  -- throw
	},
	Animations = 
	{
		"frog_walk_01",   -- walking
		"frog_idle_01",   -- idle1
	},
	Editor = {
		Icon = "Bug.bmp"
