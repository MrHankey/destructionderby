Chickens = {
  ...
  MapVisMask = 0,
	...
	{
		"Sounds/environment:random_oneshots_natural:chicken_cluck",   -- idle 
		"Sounds/environment:random_oneshots_natural:chicken_run",     -- scared
		"Sounds/environment:random_oneshots_natural:chicken_dies",    -- die
		"Sounds/environment:random_oneshots_natural:chicken_throw",   -- pickup
		"Sounds/environment:random_oneshots_natural:chicken_throw",   -- throw
	},
	Animations = 
	{
		"walk_loop",   -- walking
