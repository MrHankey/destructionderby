...
--	$Id$
--	$DateTime$
--	Description: Implementation of an asian tank
--  
--------------------------------------------------------------------------
--  History:
...
--------------------------------------------------------------------------
function Asian_tank:GetSpecificFireProperties()
...
--------------------------------------------------------------------------
Asian_tank.AIProperties = 
{
	-- AI attributes
  AIType = AIOBJECT_CAR,
  AICombatClass = SafeTableGet(AICombatClasses, "Tank"),
  AIDefaultSpecies = 1,	-- this is chinese vehicle 
  PropertiesInstance = 
  {
