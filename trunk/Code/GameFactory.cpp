...
//  REGISTER_FACTORY(pFramework, "Aliens/Observer", CObserver, true);
  ...
  //REGISTER_FACTORY(pFramework, "Aliens/Coordinator", CObserver, true);
    ...
    pFramework->GetIGameRulesSystem()->RegisterGameRules("DestructionDerby", "GameRules");
	pFramework->GetIGameRulesSystem()->AddGameRulesAlias("DestructionDerby", "dd");
	pFramework->GetIGameRulesSystem()->AddGameRulesLevelLocation("DestructionDerby", "multiplayer/dd/");
#endif //spdemo
