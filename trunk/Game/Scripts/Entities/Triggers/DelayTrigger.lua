...
function DelayTrigger:Event_OutputTrigger( sender )
	if (self.bEnabled ~=0) then
--		System.Log(self:GetName().." Event_OutputTrigger");
...
--	System.Log(self:GetName().." OnTimer");
...
DelayTrigger.FlowEvents =
{
	Inputs =
	{
		Disable = { DelayTrigger.Event_Disable, "bool" },
		Enable = { DelayTrigger.Event_Enable, "bool" },
		InputTrigger = { DelayTrigger.Event_InputTrigger, "bool" },
		OutputTrigger = { DelayTrigger.Event_OutputTrigger, "bool" },
	},
	Outputs =
	{
		Disable = "bool",
