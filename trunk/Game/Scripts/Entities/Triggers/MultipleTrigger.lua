...
MultipleTrigger.FlowEvents =
{
	Inputs =
	{
		Disable = { MultipleTrigger.Event_Disable, "bool" },
		Enable = { MultipleTrigger.Event_Enable, "bool" },
		InputTrigger = { MultipleTrigger.Event_InputTrigger, "bool" },
		OutputTrigger = { MultipleTrigger.Event_OutputTrigger, "bool" },
	},
	Outputs =
	{
		Disable = "bool",
