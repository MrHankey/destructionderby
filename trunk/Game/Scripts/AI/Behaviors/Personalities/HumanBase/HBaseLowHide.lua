--------------------------------------------------
--   Created By: Kirill
--   Description: This is the combat behaviour of the Camper


AIBehaviour.HBaseLowHide = {
	Name = "HBaseLowHide",
	alertness = 2,
	base = "CamperAttack",
...
--   	entity:InsertSubpipe(0, "throw_grenade");
	...
	OnEnemyDamage = function ( self, entity, sender,data)
		...
		entity:Supress( 3 );
		-- data.id: the shooter
		AI.LogEvent(entity:GetName().." ONENEMY DAMAGE HBaseLowHide");
		entity:Readibility("GETTING_SHOT_AT",1);
		
		self:SUPRESSED(entity, sender,data);
...
--		System.Log("--------OnReload");
	...
	OnGroupMemberDied = function( self, entity )
		...
		AI.LogEvent(entity:GetName().." OnPlayerdied in HBaseLowHide");
