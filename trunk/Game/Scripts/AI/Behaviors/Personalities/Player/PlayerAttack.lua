...
--	$Id$
--	$DateTime$
--	Description: Player attack - signal callback container
--  
--------------------------------------------------------------------------
--  History:
--  - 6/2006     : Created by Luciano Morpurgo
--
--------------------------------------------------------------------------


AIBehaviour.PlayerAttack = {
	Name = "PlayerAttack",
	...
	OnNavTypeChanged  = function(self,entity,sender,data)
		AIBehaviour.PlayerIdle:StartAttack(entity,data.iValue);
	end,	
