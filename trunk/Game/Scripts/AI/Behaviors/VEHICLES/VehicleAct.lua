...
--	$Id$
--	$DateTime$
--	Description: Implementation of a common flow-graph actions for vehicles
--  
--------------------------------------------------------------------------
--  History:
...
AIBehaviour.VehicleAct = {
	...
	Constructor = function(self , entity )
		...
		-- entity.vehicleIgnorantIssued = nil;
	end,
	
	---------------------------------------------
	ACT_GOTO = function( self,entity,sender,data )
	--AI.LogEvent(">>>> ACT_MOVE "..entity:GetName());	
	...
	ACT_FOLLOW = function( self,entity,sender,data )
		AI.LogEvent(">>>> ACT_FOLLOW "..entity:GetName());
		entity:Act_Follow( sender );
	end,
	...
	---------------------------------------------
	CHECK_DRIVER = function( self,entity,sender )
