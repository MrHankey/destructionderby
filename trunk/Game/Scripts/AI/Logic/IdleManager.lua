...
--			local formatted_name = string.format("idle%02d",idleCounter);
--			while (entity:GetAnimationLength(0, formatted_name)~=0) do
--				self.ModelTable[model][idleCounter+1] = {Name = formatted_name, Tag=0 };
--				idleCounter = idleCounter + 1;
--				formatted_name = string.format("idle%02d",idleCounter);
--			end
