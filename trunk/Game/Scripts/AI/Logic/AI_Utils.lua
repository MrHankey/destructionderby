...
--	else
--		entity:SelectPipe(0,"cv_look_interested");
--		return false;
--	end
end
...
--	if(forceTerritory and not entity.AI.TerritoryShape) then
--		-- Try nearby hidespot
--		local hidePos = AI.GetNearestHidespot(entity.id, 0, 10);
--		if(hidePos) then
--			entity.AI.TerritoryShape = AI.CreateTempGenericShapeBox(hidePos, 15, 0, AIAnchorTable.COMBAT_TERRITORY);
--		else
--			entity.AI.TerritoryShape = AI.CreateTempGenericShapeBox(entity:GetPos(), 15, 0, AIAnchorTable.COMBAT_TERRITORY);
--		end
--	end
